...
### The four differentiation bets, sized to the evidence

Reviewed 2026-09-18 against the verified evidence base. Three of the four rest on **absence of evidence, not evidence of absence**, and must be stated as gaps in _published capability_ rather than as proven product gaps.

| Bet                                  | Status                                 | How it may be stated                                                                                                   |
| ------------------------------------ | -------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| 3. Minimal-churn what-if re-planning | Independent quantified baseline exists | **Lead differentiator.** The only bet with external evidence of the problem                                            |
| 1. Validator-as-authority            | Whitespace **by silence**              | "Not described in published capability" — never "absent"                                                               |
| 2. Binding-constraint explainability | Whitespace **by silence**              | Same. The vendor TAMS page carries no reference to explainability or binding constraints, which is silence, not denial |
| 4. Auditable per-contractor handover | Whitespace **by silence**              | Same                                                                                                                   |

The caution is necessary because market coverage is partial. The incumbent picture rests on **two operators** (Network Rail, SMRT). **Bentley, Trapeze, Hitachi Rail, Siemens Mobility, Hexagon, Atkins/Jacobs in-house tools, RailSys and OpenTrack produced zero verified findings.** Any claim that commercial vendors lack these features is unsupported. Separately, the strongest supporting claims for bets 1 and 2 were killed in adversarial verification — see the do-not-say list in [PS1_EVIDENCE_BASE.md](PS1_EVIDENCE_BASE.md#4-do-not-say--claims-that-failed-verification).

**Demonstrably not differentiated:** conflict checking existing at all, workflow digitalisation, real-time status, dashboard reporting, and "an optimiser" as a concept. All are present in the Singapore incumbent, and conflict detection plus trade-off optimisation is the stated purpose of Network Rail's Access Planning Programme.

Never write "no competitor does this", in any wording.

### The one independent baseline: possession churn

Bet 3 is the lead differentiator because it is the only one with an external, quantified problem baseline. The ORR/GHD Independent Reporter possessions efficiency review of **April 2021** found that **17–22% of previously agreed possessions were cancelled before delivery** in every Network Rail Route except Wessex (15%), and that the **T-7 late-change lockdown was ineffective**, because the peak of changes occurred at T-7 itself — when changes should have been permitted only where business or safety critical.[^17]

Provenance is strong and the incentives run the right way: GHD was appointed by ORR and Network Rail as statutory Independent Reporter, working from large Possession Planning System (PPS) and NROL data extracts plus 100+ consulted stakeholders across all Routes nationally. It is a regulator-commissioned review critical of Network Rail, not vendor marketing. This lands on the Tier 3 disruption re-planning already shipped in `d506522`.

Four citation rules are verification-imposed and not optional:

- Cite as "ORR/GHD Independent Reporter review, **April 2021**", in **past tense**. It is 5.5 years old and predates the current Region/Route structure and the GBR transition.
- **Drop the word "mandatory"** from any lockdown description. The report says "There is no one single lockdown mechanism"; processes differ across Network Rail.
- The T-7 peak is the national headline, qualified by footnote 29 — Southern Region rises week-on-week to delivery, and Wales & Western peaks again near the T-12 Informed Traveller deadline.
- Present 17–22% as a **problem baseline only, never as an endorsed remedy.** GHD's own recommendations are a late-change root-cause survey, governance consolidation under APP, and PPS change categorisation. It does **not** recommend minimal-churn re-planning software.
...
[^4]: LTA, SMRT and SBS Transit. [Progressive implementation of Rail Reliability Taskforce recommendations](https://www.lta.gov.sg/content/ltagov/en/newsroom/2026/2/news-releases/lta-rail-operators-progressively-implement-rail-reliability-taskforce-to-strengthen-network-reliability.html), joint news release, 13 February 2026. Cite only for: more engineering hours being set aside, including longer service closures where needed ("where needed" attaches to the closures, not the hours); renewal prioritised across "three critical systems – power, signalling, and trains"; North East Line power supply renewal brought forward to commence in 2026; and the stated inherent coordination challenge of renewing multiple systems while maintaining daily operations. It does **not** support an engineering-hour scarcity premise — it states the opposite — and it is not evidence that LTA's current process fails or that LTA is seeking tooling. A keyword scan of its 14,193-character body returns zero hits for "track access", "possession", "maintenance window" or "contractor". See [PS1_EVIDENCE_BASE.md](PS1_EVIDENCE_BASE.md#2-the-singapore-policy-context).
...
[^16]: Dewald Cillie and James Bekker. [Development of a maintenance possession scheduler for a railway](https://sajie.journals.ac.za/pub/article/view/2750), _South African Journal of Industrial Engineering_ 34(2), 1–21, 25 August 2023. DOI: 10.7166/34-2-2750. Publisher abstract establishes model, horizon and case context.

[^17]: ORR / GHD. [Possessions efficiency review — Independent Reporter report](https://www.orr.gov.uk/sites/default/files/2021-10/ghd-possessions-efficiency-review-independent-report-april-2021.pdf), April 2021. Statutory Independent Reporter review commissioned by ORR and Network Rail, drawing on PPS and NROL data extracts and 100+ consulted stakeholders across all Routes. Cite in past tense as a **problem baseline only**; the review does not recommend minimal-churn re-planning software, and the "mandatory lockdown" wording must not be used. See [PS1_EVIDENCE_BASE.md](PS1_EVIDENCE_BASE.md#citation-rules-for-findings-8-and-9) for the full citation rules.
