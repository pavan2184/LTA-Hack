...
The sandbox already demonstrates repairs, alternatives, pins and disruptions;
connecting revisions to saved plans and the guided flow are implemented locally
but still uncommitted as of this update. [Project status](PROJECT_STATUS.md)
