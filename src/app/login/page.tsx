...
export default async function Login({ searchParams }: { searchParams: Promise<{ error?: string; returnTo?: string }> }) {
  ...
  return <main className="login-page mx-auto flex min-h-screen max-w-md flex-col justify-center px-6 py-12">
