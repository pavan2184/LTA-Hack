...
export default async function Home() {
  ...
  return <><div className="flex items-center justify-end gap-3 border-b px-6 py-2"><Link href="/plans" className="text-sm underline">Saved plans</Link><span className="text-xs">Planner workspace</span><SignOut /></div><DashboardShell /></>;
}
