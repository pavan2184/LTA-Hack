...
Open `/sandbox` as a planner and load the fabricated requests. Its six pages separate
Overview, Requests, Conflicts, Schedule, Resources and Scenarios.
...
- [x] Integrated role workspaces and six sandbox pages.
